...
let preprocessor = 'sass'; // Выбор препроцессора в проекте - scss или less
...
function styles() {
  return src('app/' + preprocessor + '/main.' + 'scss' + '') // Выбираем источник: "app/sass/main.scss" или "app/less/main.less"
